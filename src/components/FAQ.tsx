...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Стоимость зависит от площади, сложности и набора услуг. Архитектурный проект частного дома — от 1 000 ₽/м², дизайн интерьера — от 3 500 ₽/м², ландшафтный дизайн — от 30 000 ₽/сотка. Точную стоимость назовём после первичной консультации.",
  },
  {
