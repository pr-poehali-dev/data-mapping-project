...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Стоимость зависит от площади, сложности и набора услуг. Архитектурный проект частного дома — от 1 000 ₽/м², дизайн интерьера — от 1 500 ₽/м², ландшафтный дизайн — от 300 ₽/м². Точную стоимость назовём после первичной консультации.",
  },
  {
