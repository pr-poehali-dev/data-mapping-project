...
const interiorTiers = [
  ...
  },
  {
    ...
    subtitle: "Фундамент грамотного ремонта. Максимум пользы при разумном бюджете. Без фотореалистичных визуализаций, но с полной технической ясностью.",
    price: "3 500 ₽",
    priceUnit: "/ м²",
    features: [
      "Итоговое планировочное решение с расстановкой мебели и эргономикой",
      "Условная визуализация — 3D-эскиз помещений",
      "План освещения и выключателей со сценариями включения",
      "План розеток и выводов инженерных сетей",
      "Экспликация помещений: площади комнат, периметр и площадь стен",
  ...
  },
  {
    ...
    features: [
      ...
      "Состав проекта собирается индивидуально — платите только за то, что нужно",
      "Можно заказать только планировку и визуализацию",
      "Можно заказать только визуализацию интерьера",
